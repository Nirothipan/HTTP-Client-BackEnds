...
public class ClientSendsChunks {
    ...
    static String payload =
            "[\n" + "   {\n" + "      \"id\":\"2489651045\",\n" + "      \"type\":\"CreateEvent\",\n" + "      " +
                    ...
                    "\"payload\":{\n" + "         \"ref\":\"master\",\n" + "         \"ref_type\":\"branch\",\n" + " " +
                    "        \"master_branch\":\"master\",\n" + "         \"description\":\"Solution to homework and " +
                    "assignments from MIT's 6.828 (Operating Systems Engineering). Done in my spare time.\",\n" + "  " +
                    "       \"pusher_type\":\"user\"\n" + "      },\n" + "      \"public\":true,\n" + "      " +
                    "\"created_at\":\"2015-01-01T15:00:00Z\"\n" + "   },\n" + "   {\n" + "      \"id\":\"2489651051" +
                    "\",\n" + "      \"type\":\"PushEvent\",\n" + "      \"actor\":{\n" + "         \"id\":3854017," +
                    "\n" + "         \"login\":\"rspt\",\n" + "         \"gravatar_id\":\"\",\n" + "         " +
                    "\"url\":\"https://api.github.com/users/rspt\",\n" + "         \"avatar_url\":\"https://avatars" +
                    ".githubusercontent.com/u/3854017?\"\n" + "      },\n" + "      \"repo\":{\n" + "         " +
                    "\"id\":28671719,\n" + "         \"name\":\"rspt/rspt-theme\",\n" + "         \"url\":\"https" +
                    "://api.github.com/repos/rspt/rspt-theme\"\n" + "      },\n" + "      \"payload\":{\n" + "       " +
                    "  \"push_id\":536863970,\n" + "         \"size\":1,\n" + "         \"distinct_size\":1,\n" + "  " +
                    ...
                    "\"name\":\"rspt\"\n" + "               },\n" + "               \"message\":\"Fix main header " +
                    "height on mobile\",\n" + "               \"distinct\":true,\n" + "               " +
                    "\"url\":\"https://api.github" +
                    ".com/repos/rspt/rspt-theme/commits/6b089eb4a43f728f0a594388092f480f2ecacfcd\"\n" + "            " +
                    "}\n" + "         ]\n" + "      },\n" + "      \"public\":true,\n" + "      \"created_at\":\"2015" +
                    "-01-01T15:00:01Z\"\n" + "   },\n" + "   {\n" + "      \"id\":\"2489651053\",\n" + "      " +
                    "\"type\":\"PushEvent\",\n" + "      \"actor\":{\n" + "         \"id\":6339799,\n" + "         " +
                    "\"login\":\"izuzero\",\n" + "         \"gravatar_id\":\"\",\n" + "         \"url\":\"https://api" +
                    ".github.com/users/izuzero\",\n" + "         \"avatar_url\":\"https://avatars.githubusercontent" +
                    ".com/u/6339799?\"\n" + "      },\n" + "      \"repo\":{\n" + "         \"id\":28270952,\n" + "  " +
                    "       \"name\":\"izuzero/xe-module-ajaxboard\",\n" + "         \"url\":\"https://api.github" +
                    ".com/repos/izuzero/xe-module-ajaxboard\"\n" + "      },\n" + "      \"payload\":{\n" + "        " +
                    " \"push_id\":536863972,\n" + "         \"size\":1,\n" + "         \"distinct_size\":1,\n" + "   " +
                    ...
                    "\"name\":\"Eunsoo Lee\"\n" + "               },\n" + "               \"message\":\"20 sample\"," +
                    "\n" + "               \"distinct\":true,\n" + "               \"url\":\"https://api.github" +
                    ".com/repos/izuzero/xe-module-ajaxboard/commits/ec819b9df4fe612bb35bf562f96810bf991f9975\"\n" +
                    "            }\n" + "         ]\n" + "      },\n" + "      \"public\":true,\n" + "      " +
    ...
    static String payloadSmall = "{\"generalData\":{\"partnerClassification\":\"employedPerson\"," + "\"contexts" +
            "\":[\"customer\"]},\"checkData\":{\"name\":\"Samsa\",\"firstName\":\"Gregor\"," +
            "\"birthDate\":\"1963-02-25\",\"nationality\":\"DEU\",\"economicArea\":\"\",\"countryOfResidence\":0," +
            "\"industrySectors\":{\"affiliations\":[{}]}}}D";
    ...
    private SSLContext createSSLContext() {
        ...
        try {
            ...
            keyStore.load(new FileInputStream( "/Users/nirothipan/Desktop/trash/http-core-testing/" + "wso2mi-4.0.0/repository/resources" +
    ...
    public SSLSocket getSSLSocket() {
        ...
        try {
            ...
            return sslSocket;
            //  new MalformedRequestHTTPS.ClientThread(sslSocket).start();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
        return null;
